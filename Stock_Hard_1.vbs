...
Cells(2, 16).Value = Great_Percent_Ticker
Cells(2, 17).Value = Format(Great_Percent, "Percent")

Cells(3, 15).Value = "Greatest % Decrease"
Cells(3, 16).Value = Least_Percent_Ticker
Cells(3, 17).Value = Format(Least_Percent, "Percent")

Cells(4, 15).Value = "Greatest Total Volume"
Cells(4, 16).Value = Great_Volume_Ticker
